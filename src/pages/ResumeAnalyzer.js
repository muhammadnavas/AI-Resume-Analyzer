            ...
            <div className={`flex items-center space-x-3 p-4 rounded-lg border ${
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  ...
                  {hasGeminiKey && <span className="text-green-500 text-xs">✓</span>}
                  {!hasGeminiKey && <span className="text-red-500 text-xs">✗</span>}
            ...
            <div className={`flex items-center space-x-3 p-4 rounded-lg border ${
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  ...
                  {file && <span className="text-green-500 text-xs">✓</span>}
                </div>
            ...
            <div className={`flex items-center space-x-3 p-4 rounded-lg border ${
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2">
                  ...
                  {hasGeminiKey && file && <span className="text-blue-500 text-xs">✓</span>}
                </div>
                <p className="text-xs text-gray-600">
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[
          { key: 'contentQuality', label: 'Content Quality', icon: '📝', description: 'Relevance and impact of content' },
          { key: 'structureOrganization', label: 'Structure & Organization', icon: '🏗️', description: 'Layout and flow' },
          { key: 'formattingDesign', label: 'Formatting & Design', icon: '🎨', description: 'Visual presentation' },
          { key: 'impactLanguage', label: 'Impact & Language', icon: '🎯', description: 'Action verbs and results' },
          { key: 'atsCompatibility', label: 'ATS Compatibility', icon: '🤖', description: 'Applicant tracking systems' }
        ].map((category) => {
